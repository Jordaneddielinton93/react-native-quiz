...
export { default as CurriculmHeader } from "./TopHeader/curriculumHeader";
...
export { default as ToipicSelection } from "./TopicSelection";
export { default as CircleBackButton } from "./Buttons/CircleBackButton";
export { default as TopSplash } from "./ImageBackground/TopSplash";
